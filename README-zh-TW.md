...
> 1. 最初製作於 **2024 年 7 月** ，這階段採用純手刻，沒有使用任何的AI工具進行輔助。2024年的作品連結： https://github.com/Take-YourTime/Pygame-Project/tree/main/Monkey%20Battle  
> 2. 在 **2026 年 3 月** Vibe Coding流行後，使用 Antigravity 等AI工具進行二次修改，並重構整個專案架構，提升程式的可擴性以及可維護性。   

<p align="center">
  <img src="./demoView/menu.png" width="75%" alt="menu">
  <img src="./demoView/game.png" width="75%" alt="game">
</p>
